...
public class RequestInviteCtrlr {
	...
	private static final Logger log = LoggerFactory
			.getLogger(RequestInviteCtrlr.class);

	@RequestMapping(value = "/requestInvite", method = RequestMethod.GET)
	public String greetingForm(
			@RequestParam(value = "projectName", required = true) String requestedProj,
			Model model) {
	...
	public String requestInvite(
		...
		String generatedEmailLink = SystemVars.rootUrl
		...
		mailSender.sendMail(
				...
				"I would like to join please! :)\n\nUser: "
						+ invite.getUserEmail() + "\nProject: "
						+ invite.getProjectName() + "\nInvite Generator URL: "
						+ generatedEmailLink);

		log.info("Finished sending a mail requesting invite for: "
				+ invite.getUserEmail());
